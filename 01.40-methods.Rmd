...
3. Consumers maximize across multiple options.
...
It is unclear to me if Two-Part or Double Hurdle models are necessary when considering FFV purchases. This makes more intuitive sense for something like cigarette or alcohol consumption (see @garcia_alternative_1996; @aristei_cohort_2008), where zero-expenditure can be the result of abstention or price/income constraints. But I'm not sure if it is necessary to explain zero FFV expenditures on something besides prices, preferences, and budget.
