...
How, then, does one think about individual participation in the DUFB program? In reality, it is stores that participate in the DUFB program while its SNAP shoppers merely have the option to benefit from the program. I imagine use the DUFB incentive depends heavily on a series latent variables corresponding to individual shoppers, stores, and the retail chain.

ow does one even identify if an individual is even participating in the program given that the DUFB incentive is applied automatically? 
