...
**Hypothesis 1**: I expect SNAP EBT expenditures on fruits and vegetables (FVs)to increase slight (1 - 2%) during the months the DUFB incentive is active in the experimental stores (Aug - Dec). The expect the effect will fade over time. I expect no significant differences in fruit and vegetable expenditures during the months the incentive is not in effect (Jan - July).
