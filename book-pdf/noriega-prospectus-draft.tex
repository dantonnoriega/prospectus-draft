...
\item
  Consumers maximize across multiple options.
\end{enumerate}
...
observation is shrunk substantially, zeros will exists due to
...
solutions---Tobit, \emph{Two-Part}, and \emph{Double Hurdle} models,
...
is explicitly formulated in the Two-Part and Double Hurdle models.
...
It is unclear to me if Two-Part or Double Hurdle models are necessary
when considering FFV purchases. This makes more intuitive sense for
something like cigarette or alcohol consumption (see
\citet{garcia_alternative_1996}; \citet{aristei_cohort_2008}), where
zero-expenditure can be the result of abstention or price/income
constraints. But I'm not sure if it is necessary to explain zero FFV
expenditures on something besides prices, preferences, and budget.
