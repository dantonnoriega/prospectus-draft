...
competing food choices and generally other outside options.\footnote{It
  ...
  fresh produce. The store itself was located in one of Chicago's poorer
  neighborhoods.} It is substantially more difficult for the shopper to
optimize over such a large set of choices. Last, and most obviously, one
set of studies targets children, the other adults. A priori, we would
expect a monetary incentive to affect children differently than adults.
The fact that habit formation through incentives appears possible for
both target groups is promising.
...
\begin{figure}
\centering
\includegraphics{noriega-prospectus-draft_files/figure-latex/plot-dd-1.pdf}
...
\includegraphics{noriega-prospectus-draft_files/figure-latex/unnamed-chunk-9-1.png}
...
\begin{figure}
\centering
\includegraphics{noriega-prospectus-draft_files/figure-latex/plot-dc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{noriega-prospectus-draft_files/figure-latex/plot-cycle-1.pdf}
