...
In this section, I outlined what I understand to be the Data Generating Process (DGP). This is important for constructing the proper model. I have not seen these data but I believe I can understand enough about it to conceptualize the DGP and construct a model.
...
1. I have no way of distinguishing *responsive* versus *unresponsive* shoppers. I have to assume that a shopper spending more on fruits and vegetables then on prior shopping trips is responding to the incentive. But this assumption is weak.
