...
The DUFB implementation for this particular grocery store chain is a point system. SNAP shoppers can *earn* points by buying locally grown produce using their SNAP EBT card and their loyalty card. The loyalty card is required because it is used to store and track earned DUFB points. Each dollar spent buying locally grown produce earns a DUFB point. SNAP shoppers are eligible to receive up to $20 dollars worth of DUFB points (20 points) per day. Earned points are not reflected immediately on loyalty cards. They are accessible the day after.

Once SNAP shoppers have accumulated points on their loyalty cards, points can then be redeemed starting the following day. Points can be redeemed on any eligible produce (excludes frozen and canned fruits and vegetables). Any form of payment can be used when redeeming points; it is not necessary to use a SNAP EBT card to redeem points.

There are four important details. I already mentioned the first but it is worth reiterating: earned points take a day to be processed on a loyalty card. This forces SNAP shoppers to delay the reward of the DUFB incentive by at least a day. While perhaps a technological necessity (it takes time to process and reflect earned points on loyalty card accounts), this delays the transactional utility that could potentially be earned by the SNAP shopper [@thaler_mental_1985]. I hypothesize that delaying the transactional utility reduces the "pleasure" and effectiveness window of the DUFB incentive. SNAP shoppers tend to do one large shopping tripSecond, and related to the first point, is that the points earned are not communicated to the shopper [@family_fare_double_2016]. 
