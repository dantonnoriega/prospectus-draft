...
The DUFB incentive can differ in implementation. Three different implementations have been observed: earn/redeem DUFB points via loyalty card, single-use paper coupon, and immediate automatic discount. The earn/redeem DUFB point system is unique to the retailer that provided these data. For information on the other two DUFB implementations, see [@margaret_schnuck_doubling_2016].
...
There are three important details about this implementation of the DUFB incentive. I already mentioned the first but it is worth reiterating: earned points take a day to be processed on a loyalty card. This forces SNAP shoppers to delay the reward of the DUFB incentive earned by at least a day. While perhaps a technological necessity (it takes time to process and reflect earned points on loyalty card accounts), this delays the transactional utility that could potentially be earned by the SNAP shopper [@thaler_mental_1985]. I hypothesize that delaying the transactional utility reduces the "pleasure" and effectiveness window of the DUFB incentive. SNAP shoppers tend to spend benefits in one large shopping trip soon after receiving monthly benefits. These shopping trips therefore correspond to the single largest opportunity to earn DUFB points. Unless the shoppers returns to the store frequently to buy fresh produce, the "reward" of redeeming points is lost. 

Second, the incentive automatically alternates between earning and redeeming process. Once points are earned, loyalty cards with a point balance greater than zero will redeem until the points are consumed. This removes the possibility of strategically "banking" earned points. Should I purchase $10 dollars of local produce and earn 10 points, the next time I purchase *any* produce (even local produce), my purchases will be redeemed 

Third, the points *earned* are not communicated to the shopper at the moment of sale [@family_fare_double_2016]. In other words, the fact that shoppers are earning points is *not salient*. There is no feedback connecting the purchase of fresh healthy produce to the fact that the shopper is earning points. Currently available points (those processed in prior shopping trips) are printed at the bottom of each receipt, and can even be checked online or on in-store kiosks. But no feedback or information is shared to the shopper during the sale. Earning points, at least, ends up being like any other shopping trip. I would argue this is more a con than a pro. Certainly a bell shouldn't ring when SNAP shoppers earn points, but shoppers could benefit from some sort of feedback. For example, are shoppers told "Congrats! You just earned 5 DUFB points!"? I would hope so. But if the points earned don't appear on the machine or receipt, how would the clerk know?
