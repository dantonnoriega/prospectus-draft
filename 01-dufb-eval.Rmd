...
a[[1]] <- ("```{r expansion, fig.width=8, fig.height=3, fig.cap = 'Expansion over time, 2014 to 2016 (left to right). Gray sectors denote higher population density.', fig.align='center', echo=FALSE}")
a[[2]] <- ("knitr::include_graphics('figures/expansion.pdf')")
...
```{r fig1-output-pdf, warning=FALSE, message=FALSE, eval=pdf_yes, echo=FALSE}
raw("\\newpage")
raw("\\blandscape")
raw("\\centering")
...
```{r fig1-output-html, warning=FALSE, message=FALSE, eval=!pdf_yes, echo=FALSE}
raw(paste(knitr::knit(text = paste(out), quiet = TRUE)))
```
<!-- ![TK stores-2014]() -->
